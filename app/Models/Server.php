...
class Server extends Model
{
    ...
    public const TYPE_GHOSTPASS = 'ghostpass';
    ...
    private const PROTOCOL_CONFIGURATIONS = [
        ...
        self::TYPE_GHOSTPASS => [
            'traffic_profile' => ['type' => 'string', 'default' => 'https-browsing'],
            'padding_rate' => ['type' => 'integer', 'default' => 3],
            'min_padding_size' => ['type' => 'integer', 'default' => 64],
            'max_padding_size' => ['type' => 'integer', 'default' => 512],
            'max_write_size' => ['type' => 'integer', 'default' => 4096],
            'timing_jitter' => ['type' => 'boolean', 'default' => true],
            'min_jitter_ms' => ['type' => 'integer', 'default' => 1],
            'max_jitter_ms' => ['type' => 'integer', 'default' => 15],
            'jitter_rate' => ['type' => 'integer', 'default' => 2],
            'burst_size' => ['type' => 'integer', 'default' => 5],
            'burst_pause_ms' => ['type' => 'integer', 'default' => 40],
