    ...
    public function config(Request $request)
    {
        ...
        $response = match ($nodeType) {
            ...
            'ghostpass' => [
                ...
                'server_port' => (int) $serverPort,
                'server_name' => $protocolSettings['tls']['server_name'],
                'fallback_addr' => $protocolSettings['fallback_addr'] ?? null,
                'traffic_profile' => $protocolSettings['traffic_profile'] ?? 'https-browsing',
                'padding_rate' => (int) ($protocolSettings['padding_rate'] ?? 3),
                'min_padding_size' => (int) ($protocolSettings['min_padding_size'] ?? 64),
                'max_padding_size' => (int) ($protocolSettings['max_padding_size'] ?? 512),
                'max_write_size' => (int) ($protocolSettings['max_write_size'] ?? 4096),
                'timing_jitter' => (bool) ($protocolSettings['timing_jitter'] ?? true),
                'min_jitter_ms' => (int) ($protocolSettings['min_jitter_ms'] ?? 1),
                'max_jitter_ms' => (int) ($protocolSettings['max_jitter_ms'] ?? 15),
                'jitter_rate' => (int) ($protocolSettings['jitter_rate'] ?? 2),
                'burst_size' => (int) ($protocolSettings['burst_size'] ?? 5),
                'burst_pause_ms' => (int) ($protocolSettings['burst_pause_ms'] ?? 40),
            ],
            'socks' => [
                ...$baseConfig,
                'server_port' => (int) $serverPort,
